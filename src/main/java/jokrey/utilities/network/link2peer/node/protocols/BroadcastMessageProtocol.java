...
public class BroadcastMessageProtocol {
    ...
    public static void asAnswererWithoutHash(P2LNodeInternal parent, P2LMessageQueue userBrdMessageQueue, BroadcastState state, SocketAddress from, P2LMessage initialMessage) {
                    ...
                    if(!peerHashKnowledgeOfMessage) {
                        try {
                            parent.sendInternalMessage(
                                    to, packBroadcastMessage(C_BROADCAST_MSG, message)
                            );
                        } catch (IOException e) {
    ...
    public static void asAnswererWithHash(P2LNodeInternal parent, P2LMessageQueue userBrdMessageQueue, BroadcastState state, SocketAddress from, P2LMessage initialMessage) throws IOException {
...
//        if(wasKnown) {
    ...
    private static P2LMessage unpackBroadcastMessage(P2LMessage message) {
        short brdMsgType = message.nextShort();
